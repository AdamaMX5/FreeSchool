(function (root, factory) {
  ...
  protoOf(atomicfu$AtomicRefArray$ref).fh = function () {
  ...
  protoOf(AtomicLong).kh = function (_set____db54di) {
    this.kotlinx$atomicfu$value = _set____db54di;
  };
  protoOf(AtomicLong).hh = function () {
    return this.kotlinx$atomicfu$value;
  };
  ...
  defineProp(protoOf(atomicfu$AtomicRefArray$ref), 'atomicfu$size', protoOf(atomicfu$AtomicRefArray$ref).fh);
  //endregion
